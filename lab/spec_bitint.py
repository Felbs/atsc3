...
RATES = ['2/15', '3/15', '4/15', '5/15', '6/15', '7/15', '8/15', '9/15', '10/15', '11/15', '12/15', '13/15']
MOD_BITS = {'QPSK': 2, '16QAM': 4, '64QAM': 6, '256QAM': 8, '1024QAM': 10, '4096QAM': 12}

# Table 6.10 -- Type A block interleaver: (Nr1, Nr2, Nc)
TYPE_A = {
    (16200, "1024QAM"): (None, None, 10),
    (16200, "16QAM"): (3960, 90, 4),
    (16200, "256QAM"): (1800, 225, 8),
    (16200, "4096QAM"): (None, None, 12),
    (16200, "64QAM"): (2520, 180, 6),
    (16200, "QPSK"): (7920, 180, 2),
    (64800, "1024QAM"): (6480, 0, 10),
    (64800, "16QAM"): (16200, 0, 4),
    (64800, "256QAM"): (7920, 180, 8),
    (64800, "4096QAM"): (5400, 0, 12),
    (64800, "64QAM"): (10800, 0, 6),
    (64800, "QPSK"): (32400, 0, 2),
}

# Table 6.11 -- Type B block interleaver: (NQCB_IG, Npart1, Npart2)
TYPE_B = {
    (16200, "1024QAM"): (10, None, None),
    (16200, "16QAM"): (4, 15840, 360),
    (16200, "256QAM"): (8, 14400, 1800),
    (16200, "4096QAM"): (12, None, None),
    (16200, "64QAM"): (6, 15120, 1080),
    (16200, "QPSK"): (2, 15840, 360),
    (64800, "1024QAM"): (10, 64800, 0),
    (64800, "16QAM"): (4, 64800, 0),
    (64800, "256QAM"): (8, 63360, 1440),
    (64800, "4096QAM"): (12, 64800, 0),
    (64800, "64QAM"): (6, 64800, 0),
    (64800, "QPSK"): (2, 64800, 0),
}

# Table 6.14 -- (MOD, output data cells per FEC frame)
DEMUX = {
    (16200, "1024QAM"): (10, None),
    (16200, "16QAM"): (4, 4050),
    (16200, "256QAM"): (8, 2025),
    (16200, "4096QAM"): (12, None),
    (16200, "64QAM"): (6, 2700),
    (16200, "QPSK"): (2, 8100),
    (64800, "1024QAM"): (10, 6480),
    (64800, "16QAM"): (4, 16200),
    (64800, "256QAM"): (8, 8100),
...
# Tables 6.12/6.13 -- mandatory modulation/coding combinations.
